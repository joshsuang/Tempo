...
const initialSettings: Settings = {
  ...
  autoStartBreaks: true, autoStartFocus: false, showSeconds: true, confirmReset: true, clearTaskOnComplete: false, keepTaskAfterComplete: true, completionBehavior: 'choices', focusIntensity: 'focused', miniTimer: false, showRecentCountdowns: true, keepAwake: false,
